...
POCKETBASE_PUBLIC_URL=\${NEXT_PUBLIC_APP_URL:-https://161-118-174-116.sslip.io}
...
grep -q '^POCKETBASE_PUBLIC_URL=' "$APP_ENV_FILE" || echo "POCKETBASE_PUBLIC_URL=\${NEXT_PUBLIC_APP_URL}" >> "$APP_ENV_FILE"
